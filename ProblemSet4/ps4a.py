...
def isValidWord(word, hand, wordList):
    ...
    if "False" in booleanValues:
        wordInHand = False
    else:
        wordInHand = True
            
    if wordInWordList is True and wordInHand is True:
        return True
    else:
        return False
    ...
    while calculateHandlen(hand) > 0:
        ...
        # Reject invalid word (print a message followed by a blank line)
         ...
         # Otherwise (the word is valid):
             ...
             print('\"', word, '\" earned', getWordScore(word, n), ' points. Total: ', score, ' points', sep=' ')
             print()
             # Update the hand 
